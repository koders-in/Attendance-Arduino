...
void loop() {
  ...
  // Ask personal data: Butt number
  Serial.println(F("Type Butt number and end it with #"));
  ...
  // Ask personal data: Employee number
  Serial.println(F("Type Employee number and end it with #"));
